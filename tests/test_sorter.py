...
def tetrode_data():
    recording, sorting_gt = toy_example(
        duration=10, num_channels=4, num_units=5, sampling_frequency=30000, num_segments=1
    )
...
def monotrode_data():
    recording, sorting_gt = toy_example(
        duration=10, num_channels=1, num_units=5, sampling_frequency=30000, num_segments=1
    )
    return recording, sorting_gt
